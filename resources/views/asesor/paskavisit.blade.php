                ...
                <div class="card">
                    ...
                    @if($role == 3 && $isHistory)
                        <div class="card-header d-flex justify-content-end" style="padding-bottom: 0">
                            <a href="{{ route('paskavisit', $pengajuan->id) }}"
                        ...
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">
                                    {{ $isHistory ? 'Hasil Penilaian Paska Visitasi' : 'Penilaian Paska Visitasi' }}</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('ekspor.penilaian') }}" method="POST"
                                                ...
                                                <input type="hidden" name="jenis_penilaian" value="Paska">
                                                <button type="submit" class="btn btn-sm rounded-pill btn-success"
                                                    title="Export Data Paska Visitasi ke Excel">
                                                    <i class='bx bx-download'></i> Export Data Paska Visitasi
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
                        ...
                        <table class="table table-bordered table-hover">
                            <thead style="background-color:#eefeff">
                                <tr style="text-align:center;">
                                    ...
                                    <th colspan="4">Hasil Nilai Pravisitasi 2</th>
                                    <th colspan="4">Penilaian Paska Visitasi</th>
                                    <th rowspan="2">
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <th>Bobot</br>Item</th>
                                    <th>
                                        <p style="word-wrap: break-word">Nilai</p>
                                    </th>
                                    <th>Bobot</br>Unsur</th>
                                    <th>Bobot</br>Subunsur</th>
                                    <th>Bobot</br>Item</th>
                            ...
                            <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @if ($loop->parent->first && $loop->first)
                                                    <td rowspan="{{ $totalItemsUnsur }}" style="text-align: center;">
                                                        {{ $uu['nilai_bobot_unsur2'] ?? '-' }}
                                                    </td>
                                                @endif
                                                @if ($loop->first)
                                                    <td rowspan="{{ $totalItemsSubunsur }}" style="text-align: center;">
                                                        {{ $su['nilai_bobot_subunsur2'] ?? '-' }}
                                                    </td>
                                                @endif
                                                <td style="text-align: center;">{{ $item['nilai_bobot2'] }}</td>
                                ...
                                <tr style="background-color:#eefeff">
                                    <td style="text-align:right" colspan="6">Total Nilai Pravisitasi 2:</td>
                                    <td style="text-align:left" colspan="2">
                                        <strong>{{ $nilai_akhir2 . ' (' . $predikat2 . ')' }}</strong>
                                    </td>
                                    <td style="text-align:right" colspan="3">Total Nilai Paska Visitasi:</td>
                                    <td style="text-align:left" colspan="2">
            ...
            <div class="row">
                <div class="col-12">
                    <button class="btn btn-primary float-sm-right" data-bs-toggle="modal"
                        data-bs-target="#modalSubmit">Submit
                        Nilai</button>
                </div>
            </div>
        @endif
    ...
    <div class="modal fade" id="nilaiModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                @else
                    <form method="POST" action="{{ route('nilai.paska') }}">
                        @csrf
        ...
        <div class="modal fade" id="modalSubmit" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('nilai.paska.submit') }}" method="POST">
                        @csrf
...
@push('scripts')
    <script>
        var urlgetnilai = '{{ route('nilai.paska.item') }}';
