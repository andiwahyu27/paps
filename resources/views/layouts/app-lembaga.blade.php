            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @if (auth()->user()->id_profile != null)
                        <li
                            class="menu-item {{ request()->routeIs('*pengajuan*') ? 'active open' : '' }} {{ request()->routeIs('*program*') ? 'active open' : '' }}">
                            ...
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{ route('pengajuan', ['type' => '1']) }}" class="menu-link">
                                        <div>Akreditasi Prakom</div>
                                    </a>
                                </li>

                                <li class="menu-item">
                                    <a href="{{ route('pengajuan', ['type' => '2']) }}" class="menu-link">
                                        <div>Akreditasi Statistisi</div>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li
                            class="menu-item
                                {{ request()->routeIs('profile.kelembagaan') ? 'active open' : '' }}
                                {{ request()->routeIs('profile.tenaga') ? 'active open' : '' }}
                                {{ request()->routeIs('profile.fasilitas') ? 'active open' : '' }}
                                {{ request()->routeIs('profile.penyelenggaraan') ? 'active open' : '' }}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <ul class="menu-sub">
                                <li
                                    class="menu-item {{ request()->routeIs('profile.kelembagaan') ? 'active open' : '' }}">
                                    <a href="{{ route('profile.kelembagaan') }}" class="menu-link">
                                        <div>Kelembagaan</div>
                                    </a>
                                </li>
                                <li class="menu-item {{ request()->routeIs('profile.tenaga') ? 'active open' : '' }}">
                                    <a href="{{ route('profile.tenaga') }}" class="menu-link">
                                        <div>Tenaga Kediklatan</div>
                                    </a>
                                </li>
                                <li
                                    class="menu-item {{ request()->routeIs('profile.fasilitas') ? 'active open' : '' }}">
                                    <a href="{{ route('profile.fasilitas') }}" class="menu-link">
                                        <div>Fasilitas Diklat</div>
                                    </a>
                                </li>
                                <li
                                    class="menu-item {{ request()->routeIs('profile.penyelenggaraan') ? 'active open' : '' }}">
                                    <a href="{{ route('profile.penyelenggaraan') }}" class="menu-link">
                                        <div>Penyelengaraan</div>
                                    </a>
                                </li>
                            </ul>
                        </li>
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('home') }}"
                                                ...
                                                <span class="align-middle">Back to reality!
                                                    <form id="back-to-reality"
                                                        action="{{ route('back.to.reality') }}" method="POST"
                                                        style="display: none;">
                                                        @csrf
                                                    </form>
                                                </span>
